...
**Base URL**: `http://www.oceanbase.ai/docs/`

---

# Documentation Overview

- **File Path**: `http://www.oceanbase.ai/docs/10.doc-overview.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/100.get-started/10.overview/10.seekdb-overview.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/100.get-started/50.embedded-mode/25.using-seekdb-in-python-sdk.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/100.get-started/100.client-server-mode/10.deploy-seekdb-testing-environment.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/100.get-started/100.client-server-mode/15.basic-sql-operations.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/100.get-started/100.client-server-mode/30.experience-vector-search.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/100.get-started/100.client-server-mode/40.experience-full-text-indexing.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/100.get-started/100.client-server-mode/50.experience-hybrid-search.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/100.get-started/100.client-server-mode/60.experience-ai-function.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/100.get-started/100.client-server-mode/70.experience-hybrid-vector-index.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/100.get-started/100.client-server-mode/80.experience-vibe-coding-paradigm-with-cursor-agent-oceanbase-mcp.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/100.get-started/150.build-ai-apps/90.build-ai-apps.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/200.develop/100.vector-search/100.vector-search-overview/100.vector-search-intro.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/200.develop/100.vector-search/100.vector-search-overview/300.vector-search-workflow.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/200.develop/100.vector-search/150.vector-embedding-technology.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/200.develop/100.vector-search/160.store-vector-data.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/200.develop/100.vector-search/200.vector-index/200.dense-vector-index.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/200.develop/100.vector-search/200.vector-index/300.hybrid-vector-index.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/200.develop/100.vector-search/200.vector-index/400.sparse-vector-index/100.in-memory-sparse-vector-index.md`

  - **Description**: Guide to in-memory sparse vector indexes for sparse vector data.

### Vector Functions

- **File Path**: `http://www.oceanbase.ai/docs/200.develop/100.vector-search/250.vector-function.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/200.develop/100.vector-search/300.vector-similarity-search.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/200.develop/100.vector-search/700.vector-search-reference/100.vector-data-type.md`

  - **Description**: Reference for vector data types in SeekDB.

- **File Path**: `http://www.oceanbase.ai/docs/200.develop/100.vector-search/700.vector-search-reference/800.vector-sdk-refer.md`

  - **Description**: Reference for vector SDK usage.

### Benchmark and FAQ

- **File Path**: `http://www.oceanbase.ai/docs/200.develop/100.vector-search/700.vector-search-benchmark-test.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/200.develop/100.vector-search/800.vector-search-faq.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/200.develop/200.hybrid-search/100.vector-index-hybrid-search.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/200.develop/300.ai-function/100.ai-function-permission.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/200.develop/300.ai-function/200.ai-function.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/200.develop/400.mcp-server/400.oceanbase-mcp-server-and-ai-tool-integration-guide.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/200.develop/500.multi-model/100.json/100.json-formatted-data-types.md`

  - **Description**: JSON formatted data types in SeekDB.

- **File Path**: `http://www.oceanbase.ai/docs/200.develop/500.multi-model/100.json/200.create-a-json-value.md`

  - **Description**: How to create JSON values in SeekDB.

- **File Path**: `http://www.oceanbase.ai/docs/200.develop/500.multi-model/100.json/300.querying-and-modifying-json-values.md`

  - **Description**: Querying and modifying JSON values in SeekDB.

- **File Path**: `http://www.oceanbase.ai/docs/200.develop/500.multi-model/100.json/400.json-formatted-data-type-conversion.md`

  - **Description**: JSON data type conversion in SeekDB.

- **File Path**: `http://www.oceanbase.ai/docs/200.develop/500.multi-model/100.json/500.json-partial-update.md`

  - **Description**: JSON partial update operations in SeekDB.

- **File Path**: `http://www.oceanbase.ai/docs/200.develop/500.multi-model/100.json/600.json-semi-struct.md`

  - **Description**: JSON semi-structured data handling in SeekDB.

### Spatial Data

- **File Path**: `http://www.oceanbase.ai/docs/200.develop/500.multi-model/200.spatial/100.spatial-data-type-overview.md`

  - **Description**: Overview of spatial data types in SeekDB for GIS applications.

- **File Path**: `http://www.oceanbase.ai/docs/200.develop/500.multi-model/200.spatial/200.spacial-reference-system.md`

  - **Description**: Spatial reference systems in SeekDB.

- **File Path**: `http://www.oceanbase.ai/docs/200.develop/500.multi-model/200.spatial/300.create-spatial-columns.md`

  - **Description**: How to create spatial columns in SeekDB.

- **File Path**: `http://www.oceanbase.ai/docs/200.develop/500.multi-model/200.spatial/400.create-spatial-indexes.md`

  - **Description**: How to create spatial indexes in SeekDB.

- **File Path**: `http://www.oceanbase.ai/docs/200.develop/500.multi-model/200.spatial/500.spatial-data-format.md`

  - **Description**: Spatial data formats supported in SeekDB.

### Character and Text

- **File Path**: `http://www.oceanbase.ai/docs/200.develop/500.multi-model/300.char-and-text/100.char-and-varchar.md`

  - **Description**: CHAR and VARCHAR data types in SeekDB.

- **File Path**: `http://www.oceanbase.ai/docs/200.develop/500.multi-model/300.char-and-text/200.text.md`

  - **Description**: TEXT data type in SeekDB.

- **File Path**: `http://www.oceanbase.ai/docs/200.develop/500.multi-model/300.char-and-text/300.full-text-index.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/200.develop/900.sdk/10.pyseekdb-sdk/10.pyseekdb-sdk-get-started.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/200.develop/900.sdk/10.pyseekdb-sdk/50.sdk-samples/10.pyseekdb-simple-sample.md`

  - **Description**: Simple sample for pyseekdb SDK usage.

- **File Path**: `http://www.oceanbase.ai/docs/200.develop/900.sdk/10.pyseekdb-sdk/50.sdk-samples/50.pyseekdb-complete-sample.md`

  - **Description**: Complete sample demonstrating all capabilities of pyseekdb SDK.

- **File Path**: `http://www.oceanbase.ai/docs/200.develop/900.sdk/10.pyseekdb-sdk/50.sdk-samples/100.pyseekdb-hybrid-search-sample.md`

  - **Description**: Hybrid search sample using pyseekdb SDK.

## Python Integration

- **File Path**: `http://www.oceanbase.ai/docs/200.develop/1000.python/20.using-seekdb-in-python-mode.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/300.integrations/100.model/100.jina.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/300.integrations/100.model/200.openai.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/300.integrations/100.model/300.qwen.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/300.integrations/200.frame/100.langchain.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/300.integrations/200.frame/200.llamaindex.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/300.integrations/200.frame/300.springai.md`

  - **Description**: Guide to integrating SeekDB vector search with Spring AI Alibaba for Java AI application development.

- **File Path**: `http://www.oceanbase.ai/docs/300.integrations/200.frame/400.dify.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/300.integrations/200.frame/500.n8n.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/300.integrations/300.mcp-client/100.cursor.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/300.integrations/300.mcp-client/200.cline.md`

  - **Description**: Guide to integrating OceanBase MCP Server with Cline.

- **File Path**: `http://www.oceanbase.ai/docs/300.integrations/300.mcp-client/300.continue.md`

  - **Description**: Guide to integrating OceanBase MCP Server with Continue.

- **File Path**: `http://www.oceanbase.ai/docs/300.integrations/300.mcp-client/400.trae.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/400.guides/400.deploy/50.deploy-overview.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/400.guides/400.deploy/100.prepare-servers.md`

  - **Description**: Server preparation guide for SeekDB deployment.

- **File Path**: `http://www.oceanbase.ai/docs/400.guides/400.deploy/600.python-seekdb.md`

  - **Description**: Embedded deployment mode using Python.

- **File Path**: `http://www.oceanbase.ai/docs/400.guides/400.deploy/700.server-mode/100.deploy-by-systemd.md`

  - **Description**: Deploy SeekDB using yum install with systemd.

- **File Path**: `http://www.oceanbase.ai/docs/400.guides/400.deploy/700.server-mode/200.deploy-by-docker.md`

  - **Description**: Deploy SeekDB in a container environment using Docker.

- **File Path**: `http://www.oceanbase.ai/docs/400.guides/400.deploy/700.server-mode/300.deploy-oceanbase-desktop.md`

  - **Description**: Deploy OceanBase Desktop application for managing SeekDB.

## OBShell

- **File Path**: `http://www.oceanbase.ai/docs/400.guides/1000.obshell/100.obshell-overview.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/400.guides/1000.obshell/300.obshell-clients/100.agent-commands.md`

  - **Description**: OBShell agent commands reference.

- **File Path**: `http://www.oceanbase.ai/docs/400.guides/1000.obshell/300.obshell-clients/200.seekdb-commands.md`

  - **Description**: OBShell seekdb commands reference.

- **File Path**: `http://www.oceanbase.ai/docs/400.guides/1000.obshell/300.obshell-clients/300.utilities-commands.md`

  - **Description**: OBShell utilities commands reference.

- **File Path**: `http://www.oceanbase.ai/docs/400.guides/1000.obshell/900.configure-monitor.md`

  - **Description**: Guide to configuring monitoring for SeekDB.

- **File Path**: `http://www.oceanbase.ai/docs/400.guides/1000.obshell/1000.error.md`

  - **Description**: OBShell error reference and troubleshooting.

## Reference

- **File Path**: `http://www.oceanbase.ai/docs/400.guides/1200.reference/1100.mysql-compatibility.md`

  - **Description**: MySQL compatibility reference for SeekDB.

- **File Path**: `http://www.oceanbase.ai/docs/400.guides/1200.reference/1500.telemetry.md`

  - **Description**: Telemetry reference for SeekDB.

## Release Notes

- **File Path**: `http://www.oceanbase.ai/docs/400.guides/1300.release-notes/10.v1.0.0.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/500.tutorials/100.create-ai-app-demo/100.build-kb-in-seekdb.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/500.tutorials/100.create-ai-app-demo/300.build-multi-model-application-based-on-oceanbase.md`
...
- **File Path**: `http://www.oceanbase.ai/docs/500.tutorials/100.create-ai-app-demo/400.build-image-search-app-in-seekdb.md`
